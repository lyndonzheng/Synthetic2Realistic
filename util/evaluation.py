...
parser.add_argument('--split', type=str, default='outdoor', help='data split')
...
parser.add_argument('--max_depth', type=float, default=80, help='maximun depth for evaluation, indoor 8.0, outdoor 80')
...
if __name__ == "__main__":
    ...
    predicted_depths = load_depth(args.predicted_depth_path,args.split, args.max_depth)
